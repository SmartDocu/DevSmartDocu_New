"""insight_sessions + insight_qas CRUD."""
from __future__ import annotations

import json
from typing import Optional

from d2insight.history import supabase_client as _sc
from d2insight.history.supabase_client import build_shares_path, delete_from_storage
...
def get_history_by_date(creator: str) -> dict:
    try:
        q = (
            _sc.table("insight_sessions")
            .select("sessionuid, sessiontitles, createdts, createdt")
